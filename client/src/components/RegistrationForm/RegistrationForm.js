...
const RegistrationForm = (props) => { //переделал форму из класса на функцию


    
     const clicked = (values) => { //register не является функцией
        ...
        const {handleSubmit, submitting, auth, authClear,register} = props;
        ...
        return (
            <div className={styles.signUpFormContainer}>
                ...
                <form onSubmit={handleSubmit(clicked)}> {/*так как тут есть метод clicked я оставил его чтобы он записывал значения в  register*/}
                    ...
                    </button> {/*  кнопка не регистрирует и в классовом компоненте тоже */}
                </form>
            </div>
        )
    }
